 ...
 * @var \App\Model\Entity\Prueba[]|\Cake\Collection\CollectionInterface $prueba
 */
?>
...
<div class="prueba index large-9 medium-8 columns content">
    <h3><?= __('Prueba') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($prueba as $prueba): ?>
            <tr>
                <td><?= $this->Number->format($prueba->id) ?></td>
                <td><?= h($prueba->nombre) ?></td>
                <td class="actions">
