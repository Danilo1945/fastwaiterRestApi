 ...
 * PlatilloFixture
 */
class PlatilloFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        'nombre_platillo' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'nombre_platillo' => 'Lorem ipsum dolor sit amet',
